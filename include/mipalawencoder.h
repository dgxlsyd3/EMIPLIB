...
/**
 * \file mipalawencoder.h
 */

#ifndef MIPALAWENCODER_H

#define MIPALAWENCODER_H
 ...
 *  encoding. The samples are converted to a-law encoded samples and a message
